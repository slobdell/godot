...
normalize "$tank" tank.hull "--forward=-x --exclude=tank_turret,tank_gun --tint=Main $tanks"
...
normalize "$props/container_small.glb" prop.crate \
	"--source='$shooter (Container Small, static.poly.pizza/2e1f581e-5f9d-42ff-9ef9-600b1cfde0a6.glb)' --credit='Quaternius, Toon Shooter Game Kit' $cc0"
...
normalize "$props/shipping_container.glb" prop.wall \
	"--repeat=4x1x1 --source='$shooter (Shipping Container, static.poly.pizza/e56c8efb-940f-4150-9bf8-d468c0165116.glb)' --credit='Quaternius, Toon Shooter Game Kit' $cc0"
...
normalize "$props/cyberpunk_signs.glb" kit.billboard \
	"--forward=-z --emissive=Texture_Signs:2.5 --source='$cyber (Cyberpunk Signs, static.poly.pizza/44299e58-2793-47f6-8245-fba288fd2bfd.glb)' --credit='Quaternius, Cyberpunk Game Kit' $cc0"
