...
check: lint test net-smoke combat-smoke broker-test relay-smoke lobby-smoke match-smoke determinism sim-baseline ## Everything headless: tests + network + relay + combat + match runner (no display/browser)
