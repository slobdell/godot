...
check: lint test net-smoke combat-smoke match-smoke determinism sim-baseline garage-smoke ## Everything headless: tests + network + combat + match runner (no display/browser)
