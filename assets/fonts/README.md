...
| `Oswald-Variable.ttf` | The arena ad screens' display face (assets X2: `game/theme/arena_kit/ads/ad_broadcast.gd`, weights through `FontVariation`); unmodified | SIL OFL 1.1 (`Oswald-OFL.txt`) | github.com/google/fonts `ofl/oswald/Oswald[wght].ttf`, 2026-09-15 |
