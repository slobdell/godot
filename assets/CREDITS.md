...
| Placeholder ad art (procedural) and copy; Oswald (display font) | giant ad screens (`game/theme/arena_kit/ads/`, `tools/assets/build_ads.py`) | generated in this repo; Oswald from github.com/google/fonts `ofl/oswald` | project-owned; Oswald SIL OFL 1.1 (`assets/fonts/Oswald-OFL.txt`) | 2026-09-15 |
