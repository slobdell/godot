...
const PROFILES := {
	...
	"gang_tank": {
		...
		"hull_size": [3.0, 4.4, 5.6],  # TEMPORARILY REVERTED for a clean balance baseline -- restored in the next commit
		"max_health": 420,
		"max_shield": 0.0,
		"shield_recharge_delay": 0.0,
		"shield_recharge_rate": 0.0,
	...
	"gang_support": {
		...
		"hull_size": [2.6, 3.6, 5.0],  # TEMPORARILY REVERTED for a clean balance baseline -- restored in the next commit
		"max_health": 260,
		"max_shield": 0.0,
		"shield_recharge_delay": 0.0,
		"shield_recharge_rate": 0.0,
