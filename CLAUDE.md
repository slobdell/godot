...
1. Read `HANDOFF.md`, then `_agents/orientation.md`, before doing anything. If you are a workstream agent, also read `_agents/workstreams.md` and your brief in `_agents/streams/`.
2. Every workflow is a Makefile target (`make help`). If `.tools/` is missing, run `make bootstrap`.
