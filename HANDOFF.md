...
- **control:** squad's hold IS on main (`4cff69b6`): the facing frame re-shoot at the lead's pose (look before sending; the pin should draw by itself); then the four teardown edits once nav's sealing merges; otherwise complete.
