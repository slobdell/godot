...
- **control:** item 4's green hash (frames landed at f007423e, check running); the "four more fixture-less tests" of 10:50 were RETRACTED at 11:05 (the guard counted a one-frame transient); the one open question is whether `test_control_response` waits for its own regions before measuring K1's 100 ms figure.
