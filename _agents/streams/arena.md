...
| X5 the arenas the lead will play | **Page built** (`make arena-page`), waiting on fresh screenshots, then it goes to the lead. This is the round-5 gate |
...
### X5 — the arena review page: built, waiting on pictures
