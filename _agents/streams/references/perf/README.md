...
| `hz30-locked30-1080.json` | `FrameTarget.LOCKED_30` (the default) at 1080p, **`--perf-capped`** | `9b07d107` | avg 41.35, p95 47.41, GPU 14.17 |
| `hz30-perf60-720.json` | `FrameTarget.PERFORMANCE_60` (~720 lines), uncapped | `9b07d107` | avg 27.04, p95 34.05, GPU 8.91; locked 30 at 13 |
| `locked30-capped-60hz-1080.json` | locked 30 measured **while the laptop carried the other agents' builds** | `15e048d8` | avg 106.05 — kept as the honest "under load" case, not as a target |
