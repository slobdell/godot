...
| `assets/announcer/masters/` — ElevenLabs MP3 masters (212k credits, 3,040 recordings after round 10) | 262 MB | No (ignored) | the laptop, builder0 (this timer), the cache drive |
