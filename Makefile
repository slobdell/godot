...
.PHONY: help bootstrap doctor import editor run demo test screenshot \
        export-web serve-web web-smoke export-server clean distclean
...
serve-web: export-web ## Export, then serve build/web at http://localhost:8060 (WEB_PORT=...)
	$(PYTHON) tools/serve_web.py $(BUILD_DIR)/web $(WEB_PORT)
